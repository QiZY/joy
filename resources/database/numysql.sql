...
CREATE TABLE `STU_CLASSINFO` (
		...
		`DESCRIPTION` varchar(255) DEFAULT NULL COMMENT '班级情况介绍',
		`TUITION` int(11) NOT NULL COMMENT '学费标准',
		`TEACHER_NAME` varchar(255) DEFAULT NULL COMMENT '教师名称',
		`TEACHER_ID` varchar(255) DEFAULT NULL COMMENT '负责的教师',
		`CREATE_USER_ID` varchar(255) DEFAULT NULL COMMENT '登记人',
		`CREATE_TIME` varchar(255) DEFAULT NULL COMMENT '登记时间',
		`STATUS` int(11) NOT NULL COMMENT '班级状态',
		`PARENT_CLASSINFO_ID` varchar(255) DEFAULT NULL COMMENT '前一个班级ID',
  		PRIMARY KEY (`CLASSINFO_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for `STU_CLASSHIS`
-- ----------------------------
DROP TABLE IF EXISTS `STU_CLASSHIS`;
CREATE TABLE `STU_CLASSHIS` (
 		`CLASSHIS_ID` varchar(100) NOT NULL,
		`CLASS_NAME` varchar(255) DEFAULT NULL COMMENT '班级名称',
		`DESCRIPTION` varchar(255) DEFAULT NULL COMMENT '班级情况介绍',
		`TUITION` int(11) NOT NULL COMMENT '学费标准',
		`TEACHER_ID` varchar(255) DEFAULT NULL COMMENT '负责的教师',
		...
		`CREATE_USER_ID` varchar(255) DEFAULT NULL COMMENT '登记人',
		`CREATE_TIME` varchar(255) DEFAULT NULL COMMENT '登记时间',
		`CLASSINFO_ID` varchar(255) DEFAULT NULL COMMENT '班级ID',
		`PARENT_CLASSINFO_ID` varchar(255) DEFAULT NULL COMMENT '前一个班级ID',
  		PRIMARY KEY (`CLASSHIS_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `STU_STUDENT` (
		...
		`CLASSINFO_ID` varchar(255) DEFAULT NULL COMMENT '班级id',
		`CLASS_NAME` varchar(255) DEFAULT NULL COMMENT '班级名称',
		`NAME` varchar(255) DEFAULT NULL COMMENT '中文名字',
		`ENG_NAME` varchar(255) DEFAULT NULL COMMENT '英文名字',
		`TEL` varchar(255) DEFAULT NULL COMMENT '家长联系电话',
		`ENTER_SCHOOL_TIME` varchar(255) DEFAULT NULL COMMENT '入学日期',
		`TUITION_EXPIRE_TIME` varchar(255) DEFAULT NULL COMMENT '学费到期时间',
		`BIRTHDY` varchar(255) DEFAULT NULL COMMENT '出生年月',
		`LISTEN_LEVEL` varchar(255) DEFAULT NULL COMMENT '听等级',
		`SPEAK_LEVEL` varchar(255) DEFAULT NULL COMMENT '说等级',
		`READ_LEVEL` varchar(255) DEFAULT NULL COMMENT '读等级',
		`WRIE_LEVEL` varchar(255) DEFAULT NULL COMMENT '写等级',
		`STUDY_PLAN` varchar(255) DEFAULT NULL COMMENT '学程规划',
		`SEMESTER_CHECK` varchar(255) DEFAULT NULL COMMENT '学期评量',
		`TUITION` int(11) NOT NULL COMMENT '应缴学费',
		`TUITION_STATUS` int(11) NOT NULL COMMENT '本次班级缴交状态',
		`CREATE_USER_ID` varchar(255) DEFAULT NULL COMMENT '登记人',
		`CREATE_TIME` varchar(255) DEFAULT NULL COMMENT '登记时间',
		`STATUS` int(11) NOT NULL COMMENT '学生状态',
  		PRIMARY KEY (`STUDENT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for `STU_STUDENTHIS`
-- ----------------------------
DROP TABLE IF EXISTS `STU_STUDENTHIS`;
CREATE TABLE `STU_STUDENTHIS` (
 		`STUDENTHIS_ID` varchar(100) NOT NULL,
		`CLASSINFO_ID` varchar(255) DEFAULT NULL COMMENT '班级id',
		`CLASS_NAME` varchar(255) DEFAULT NULL COMMENT '班级名称',
		`NAME` varchar(255) DEFAULT NULL COMMENT '中文名字',
		`ENG_NAME` varchar(255) DEFAULT NULL COMMENT '英文名字',
		...
		`STUDY_PLAN` varchar(255) DEFAULT NULL COMMENT '学程规划',
		`SEMESTER_CHECK` varchar(255) DEFAULT NULL COMMENT '学期评量',
		`TUITION` int(11) NOT NULL COMMENT '应缴标准',
		`TUITION_STATUS` int(11) NOT NULL COMMENT '本次班级缴交状态',
		`CREATE_USER_ID` varchar(255) DEFAULT NULL COMMENT '登记人',
		`CREATE_TIME` varchar(255) DEFAULT NULL COMMENT '登记时间',
		`STUDENT_ID` varchar(255) DEFAULT NULL COMMENT '学生表ID',
  		PRIMARY KEY (`STUDENTHIS_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for `STU_STUDENTTUITION`
-- ----------------------------
DROP TABLE IF EXISTS `STU_STUDENTTUITION`;
CREATE TABLE `STU_STUDENTTUITION` (
 		`STUDENTTUITION_ID` varchar(100) NOT NULL,
		`CLASSINFO_ID` varchar(255) DEFAULT NULL COMMENT '班级id',
		`CLASS_NAME` varchar(255) DEFAULT NULL COMMENT '班级名称',
		`STUDENT_ID` varchar(255) DEFAULT NULL COMMENT '学生表ID',
		`NAME` varchar(255) DEFAULT NULL COMMENT '学生中文名字',
		`AMOUNT` int(11) NOT NULL COMMENT '已缴费用',
		`TUITION_EXPIRE_TIME` varchar(255) DEFAULT NULL COMMENT '学费到期时间',
		`TUITION_PAY_TIME` varchar(255) DEFAULT NULL COMMENT '费用缴交时间',
		`CREATE_USER_ID` varchar(255) DEFAULT NULL COMMENT '登记人',
		`CREATE_TIME` varchar(255) DEFAULT NULL COMMENT '登记时间',
  		PRIMARY KEY (`STUDENTTUITION_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
