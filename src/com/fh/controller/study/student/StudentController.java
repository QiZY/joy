package com.fh.controller.study.student;
...
import com.fh.service.study.student.StudentService;
...
public class StudentController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd.put("CREATE_TIME", "");	//登记时间
		pd.put("STATUS", "1");	//学生状态
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			mv.setViewName("study/student/student_list");
	...
	public ModelAndView goAdd(){
		...
		pd = this.getPageData();
		try {
			mv.setViewName("study/student/student_edit");
	...
	public ModelAndView exportExcel(){
		...
		try{
			...
			for(int i=0;i<varOList.size();i++){
				...
				vpd.put("var19", varOList.get(i).get("STATUS").toString());	//19
				varList.add(vpd);
			}
